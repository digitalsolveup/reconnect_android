...
import com.software.somding.presentation.common.NavigationUtil.navigateWithBundle
...
class ReportDetailFragment : BaseFragment<FragmentReportDetailBinding>(R.layout.fragment_report_detail) {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		binding.reportbtn.setOnClickListener {
			...
			navigateWithBundle(R.id.action_reportDetailFragment_to_reportRegistrationFragment, bundle)
		}
	}
